# -*- coding: utf-8 -*-
#
# IndentByFold documentation build configuration file, created by
...
htmlhelp_basename = 'IndentByFolddoc'
...
latex_documents = [
  ('index', 'IndentByFold.tex', 'IndentByFold Documentation',
...
man_pages = [
    ('index', 'IndentByFold', 'IndentByFold Documentation',
     ['Frank Fesevur'], 1)
]
...
texinfo_documents = [
  ('index', 'IndentByFold', 'IndentByFold Documentation',
   'Frank Fesevur', 'IndentByFold', 'A plugin for Notepad++ that uses the fold points to indent the code',
   'Miscellaneous'),
]
